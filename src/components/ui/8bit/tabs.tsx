...
function TabsList({
  ...
  return (
    ...
    >
      <div
        className="absolute inset-0 border-y-6 -my-1.5 border-foreground pointer-events-none dark:border-ring"
        aria-hidden="true"
      />

      <div
        className="absolute inset-0 border-x-6 -mx-1.5 border-foreground pointer-events-none dark:border-ring"
        aria-hidden="true"
      />
      {children}
    </ShadcnTabsList>
